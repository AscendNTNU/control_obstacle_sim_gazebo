...
GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:$catkin_ws_dir/src/control_obstacle_sim_gazebo/models
...
GAZEBO_PLUGIN_PATH=$GAZEBO_PLUGIN_PATH:$px4_dir/build_sitl_default/build_gazebo
